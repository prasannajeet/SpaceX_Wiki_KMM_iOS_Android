...
import app.prasan.spacexwiki.FlowAdapter
...
abstract class CallbackViewModel<VM: ViewModel> {
    ...
    fun <T : Any> Flow<T>.asCallbacks() =
        FlowAdapter(getViewModel().viewModelScope, this)

    @Suppress("Unused") // Called from Swift
    fun clear() = getViewModel().clear()
}
